...
def merge_pdfs():
    ...
    with open("/tmp/file2.pdf", "wb") as file:
        file.write(pdf_bytes2)

    # Open the first PDF file
    pdf1 = open('/tmp/file1.pdf', 'rb')
    pdf1_reader = PyPDF2.PdfReader(pdf1)

    # Open the second PDF file
    pdf2 = open('/tmp/file2.pdf', 'rb')
    ...
    pdf_output = open('/tmp/merged.pdf', 'wb')
    ...
    # Open the PDF file
    with open('/tmp/merged.pdf', 'rb') as f:
        pdf_bytes = f.read()
